...
const initData = [
  {
    ...
    video: "",
    photo:
      "https://firebasestorage.googleapis.com/v0/b/benjamin-region-hongkong.appspot.com/o/kimcuong%2F3.jpg?alt=media",
    CAT_NAME: "",
  },
];
...
const Item = (props) => {
  ...
  const link = data.meta_title ? '/'+data.meta_title.replace(/,/g,'/')+'/'+data.slug : '' 
          ...
          <div className="container">
            <div className="main-banner-content">
              ...
              <div className="btn-box">
                ...
                <Link href="#" >
                  <a style={{ marginTop:10}} className="default-btn" 
                    onClick={(e) => {
                      e.preventDefault();
